...
const WeatherCard = ({ location, onClick }: WeatherCardProps) => {
  const { city, weather } = location;

  return (
    <Card 
      className="glass-card hover:shadow-lg transition-all duration-300 cursor-pointer hover:scale-[1.02] animate-fade-in"
      onClick={onClick}
    >
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 pt-3 border-t">
          ...
          <div className="flex items-center gap-2">
            <Wind className="h-4 w-4 text-weather-secondary" />
            <div>
          ...
          <div className="flex items-center gap-2">
            <Eye className="h-4 w-4 text-weather-secondary" />
            <div>
          ...
          <div className="flex items-center gap-2">
            <Gauge className="h-4 w-4 text-weather-secondary" />
            <div>
              <p className="text-xs text-muted-foreground">Pressure</p>
              <p className="font-medium">{weather.pressure} mb</p>
            </div>
          </div>
        </div>
